...
export const metadata = {
  title: 'Saulat | Personal Portfolio',
  description: 'Saulat is a full stack software Engineer with expertise in cutting edge tecgnologies',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative h-[8000px] pt-28
      sm:pt-36`}>
